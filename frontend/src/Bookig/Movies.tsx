...
const MovieDetails: React.FC = () => {
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:5000/api/movie/getMovieDetail/${movieId}`,
          {
            method: 'GET',
            headers: {
              accept: '*/*',
    ...
    const fetchVisualFormats = async () => {
      try {
        const response = await fetch(
          'http://localhost:5000/api/MovieVisualFormat/GetMovieVisualFormatList',
          {
            method: 'GET',
            headers: {
              accept: '*/*',
  ...
  const handleGetBookingInfo = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/Cinema/getCinemaInfoBookingService?MovieID=${movieId}&movieVisualFormatID=${visualId}`,
        {
          method: 'GET',
          headers: {
            accept: '*/*',
  ...
  const fetchRoomInfo = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/CinemaRoom/GetRoomInfo?movieID=${movieId}&scheduleDate=${selectedDate}&HourId=${selectedShowTime}&movieVisualID=${visualId}`,
        {
          method: 'GET',
          headers: {
            accept: '*/*',
  ...
  const fetchPriceInfo = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/Price/getPrices/${visualId}`,
        {
          method: 'GET',
          headers: {
            accept: '*/*',
  ...
  const fetchFoodInfo = async () => {
    try {
      const response = await fetch(
        'http://localhost:5000/api/Food/GetFoodInformation',
        {
          method: 'GET',
          headers: {
            accept: '*/*',
  ...
  const handleBooking = async () => {
    ...
    try {
      const scheduleResponse = await fetch(
        `http://localhost:5000/api/Schedule/getMovieScheduleId?movieId=${movieId}&HourId=${selectedShowTime}&cinemaRooomId=${roomInfo.cinemaRoomId}&showDate=${selectedDate}&movieVisualID=${visualId}`,
        {
          method: 'GET',
          headers: {
            accept: '*/*',
      ...
      const bookingResponse = await fetch('http://localhost:5000/api/Booking/Booking', {
        method: 'POST',
        headers: {
          accept: '*/*',

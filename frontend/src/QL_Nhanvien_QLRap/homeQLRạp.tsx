...
const Info: React.FC = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5000/api/Food/GetFoodInformation')
            .then(response => {
    ...
    const handleSubmitOrder = async () => {
        ...
        try {
            ...
            await axios.post(
                `http://localhost:5000/api/StaffOrder/StaffOrder?UserId=${userId}`,
                orderData,
                {
                    headers: {
                        'accept': '*/*',
    ...
    const handleDeleteCinema = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/Cinema/deleteCinema/${selectedCinemaId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('authToken')}`,
    ...
    const handleChangePassword = async () => {
        ...
        const apiUrl = `http://localhost:5000/api/Account/changePassword?userID=${localStorage.getItem('IDND')}`;
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/movie/createMovie', {
                method: "POST",
    ...
    useEffect(() => {
        const fetchCinemas = async () => {
            try {
                const response = await fetch("http://localhost:5000/api/Cinema/getCinemaList");
    ...
    useEffect(() => {
        ...
        const fetchVisualFormats = async () => {
            try {
                const response = await fetch('http://localhost:5000/api/MovieVisualFormat/GetMovieVisualFormatList', {
                    headers: {
                        'accept': '*/*',
                    },
                });
    ...
    const handleSaveCinema = async () => {
        try {
            const response = await fetch('http://localhost:5000/api/Cinema/addCinema', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('authToken')}`,
    ...
    const handleSaveRoom = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/CinemaRoom/CreateRoom', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('authToken')}`,
    ...
    const fetchCinemas = async () => {
        setLoading(true);
        try {
            const response = await axios.get<ApiResponse<Cinema[]>>('http://localhost:5000/api/Cinema/getCinemaList', {
                headers: {
                    'accept': '*/*'
                },
            });
    ...
    const fetchVisualFormats = async () => {
        setLoading(true);
        try {
            const response = await axios.get<VisualFormat[]>('http://localhost:5000/api/MovieVisualFormat/GetMovieVisualFormatList', {
                headers: {
                    'accept': '*/*',
                },
            }
    ...
    useEffect(() => {
        const fetchRoles = async () => {
            ...
            try {
                ...
                const response = await fetch("http://localhost:5000/api/Staff/GetRoleList", {
                    method: 'GET',
                    headers: {
                        'accept': '*/*',
    ...
    const fetchStaffList = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5000/api/Staff/GetStaffList", {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${authToken}`
    ...
    const handleAddStaffSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5000/api/Staff/AddStaff", {
                method: "POST",
    ...
    const handleDelete = async (staffIdToDelete: string): Promise<void> => {
        ...
        try {
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`http://localhost:5000/api/Staff/DeleteStaff?id=${staffIdToDelete}`, {
                method: "DELETE",
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`http://localhost:5000/api/Staff/editStaff?id=${editingStaff.staffId}`, {
                method: "PATCH",

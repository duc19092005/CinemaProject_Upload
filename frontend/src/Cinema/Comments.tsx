...
const Comments: React.FC = () => {
        ...
        const fetchMovieDetails = async () => {
            try {
                ...
                const commentsResponse = await fetch(
                    `http://localhost:5000/api/Comment/getComment/${movieId}`,
                    {
                        method: 'GET',
                        headers: {
                            accept: '*/*',
    ...
    const handleConfirmPost = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:5000/api/Comment/uploadComment/${userId}/${movieId}?commentDetail=${encodeURIComponent(commentToPost)}`,
                {
                    method: 'POST',
                    headers: {
                        accept: '*/*',
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:5000/api/Comment/editComment/${editingCommentId}?commentDetail=${encodedCommentDetail}`,
                {
                    method: 'PATCH',
                    headers: {
                        accept: '*/*',

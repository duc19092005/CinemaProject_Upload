...
const CinemaPage: React.FC = () => {
  ...
  const fetchCinemas = async () => {
    ...
    try {
      const response = await axios.get<ApiResponse<Cinema[]>>(
        'http://localhost:5000/api/Cinema/getCinemaList',
        {
          headers: {
  ...
  const fetchRoomsByCinema = async (cinemaId: string) => {
    ...
    try {
      const response = await axios.get<ApiResponse<RoomApiResponseData>>(
        `http://localhost:5000/api/CinemaRoom/SearchRoomByCinemaId?CinemaId=${cinemaId}`,
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('authToken')}`,
          },
  ...
  const fetchRoomDetail = async (roomId: string) => {
    ...
    try {
      const response = await axios.get<ApiResponse<RoomDetailResponseData>>(
        `http://localhost:5000/api/CinemaRoom/GetRoomDetail/${roomId}`,
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('authToken')}`,
          },
  ...
  const handleSaveCinema = async () => {
    try {
      const response = await fetch(
        'http://localhost:5000/api/Cinema/addCinema',
        {
          method: 'POST',
          headers: {
  ...
  const handleUpdateCinema = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/Cinema/editCinema/${editingCinema.cinemaId}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleDeleteCinema = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/Cinema/deleteCinema/${selectedCinemaId}`,
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleSaveRoom = async () => {
    ...
    try {
      const response = await fetch(
        'http://localhost:5000/api/CinemaRoom/CreateRoom',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleUpdateRoom = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/CinemaRoom/UpdateRoom/${editingRoom.cinemaRoomId}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleDeleteRoom = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/CinemaRoom/DeleteRoom/${roomToDeleteId}`,
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',

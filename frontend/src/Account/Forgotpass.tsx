...
const ForgotPassword: React.FC = () => {
    ...
    const handleSendEmail = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:5000/api/Email/send?email=${encodeURIComponent(email)}`,
                {
                    method: "POST",
                    headers: { "accept": "*/*" },
                }
    ...
    const handleVerifyCode = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:5000/api/Auth/VerifyEmailCode?EmailAddress=${encodeURIComponent(email)}&code=${code}`,
                {
                    method: "POST",
                    headers: { "accept": "*/*" },
                }
    ...
    const handleResetPassword = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/Account/ResetPassword`, {
                method: "POST",
